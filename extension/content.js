...
// --- Get policy from popup (simplified for demo) ---
...
// --- Setup textarea interception (existing chat) ---
function setupInterception() {
  const textarea = document.querySelector("#messageInput");
  const sendButton = document.querySelector("#sendButton");
  const chatForm = document.querySelector("#chatForm");

  if (!textarea || !sendButton || !chatForm) return;
...
function setupFileScanning() {
  ...
  const scanFileButton = document.querySelector("#scanFileButton");
...
console.log("[LeakLens] Interception and file scanning ready.");